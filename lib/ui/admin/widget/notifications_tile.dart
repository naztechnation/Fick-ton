...
class NotificationTile extends StatelessWidget {
 ...
 final Function(String notifyId) onDeleteTapped;
  ...
  const NotificationTile({super.key, required this.notifications, required this.onDeleteTapped});
          ...
          child: Container(
            ...
            child: ListTile(
              ...
              trailing: GestureDetector(
                onTap: (){
                              Modals.showAlertOptionDialog(context, title: 'Delete Notification', message: 'Are you sure you want to delete this notification. This cannot be Undone.', callback: (){onDeleteTapped(notifications[index].id ?? '');});
                            },
